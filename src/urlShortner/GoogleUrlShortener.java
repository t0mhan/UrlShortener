...
public final class GoogleUrlShortener {
    ...
    public static String shortenUrl(String longUrl) throws IOException, JSONException {
        OAuthService oAuthService = new ServiceBuilder().apiKey("AIzaSyDQ3xz8TrWB0ebOHasO8z7vGEeqDFbnSY8").apiSecret("anonymous")
                .scope("https://www.googleapis.com/auth/urlshortener") .build(GoogleApi20.instance());
        OAuthRequest oAuthRequest = new OAuthRequest(Verb.POST, "https://www.googleapis.com/urlshortener/v1/url?key=AIzaSyCNrZGy8oLPkQxzf6xQxqyTKjXCjCH4ZYw",oAuthService);
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        System.out.println("Shortened URL is: \n"+GoogleUrlShortener.shortenUrl(longUrl));
        inputUrl.close();
    }
